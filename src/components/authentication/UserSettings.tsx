...
import { determineUrl } from "../../types/utils.ts";
    ...
    useEffect(() => {
        fetch(`/api/userdata/${userUuid}`, {
            ...
            .then((data: IApiUserData) => {
                if (data.watchlist)
                    setWatchlist(
                        JSON.parse(data.watchlist.split("|").join(","))
                    );
                setUserData({
    ...
    return (
        <>
            {!userUuid ? (
                <div>
                    <p>
                        Моля влезте в акаунта си за да имате достъп до
                        настройките. Ще бъдете препратени към началото на сайта.
                    </p>
                </div>
            ) : (
                <>
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground">
                                            гледа от{" "}
                                            {`${userData.registrationDate.toLocaleString(
                                                "bg",
                                                {
                                                    month: "long",
                                                }
